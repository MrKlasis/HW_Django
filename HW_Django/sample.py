    ...
    <div class="col -4">
        ...
        <thead>
          ...
          <tbody>
            <tr>
                <th scope="row">1</th>
                <td>Облачное хранилище 2gb</td>
                <td>100$</td>
                <td>1</td>
                <td>100$</td>
                <td class="new">Новый</td>
            </tr>
            <tr>
                <th scope="row">2</th>
                <td>Облачное хранилище 10gb</td>
                <td>200$</td>
                <td>1</td>
                <td>200$</td>
            ...
            <tr>
                ...
                <td>10</td>
                <td>240$</td>
                <td class="processed">Обработан</td>
            </tr>
            <tr>
                <th scope="row">2</th>
                <td>Пакет акций twitter (50шт)</td>
                <td>1000$</td>
                <td>1</td>
                <td>1000$</td>
                <td class="cancelled">Отмена</td>
            </tr>
            <script>
